const CACHE='samen-thuis-v11-travel-priority-sync';
const ASSETS=['./','./index.html','./styles.css','./upgrade-v11.css','./app.js','./upgrade-v11.js','./manifest.webmanifest','./icon.svg'];
